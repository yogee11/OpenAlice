...
export const en = {
  ...
  workspace: {
    ...
    deleteConfirm: 'Delete workspace? (Registry only — files on disk are kept.)',
    ...
    templateUpgrade:
      'Template moved from v{{from}} → v{{to}}. The agent can self-upgrade by reading the new README and updating this workspace.',
